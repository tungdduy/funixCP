...
export class LabelMode {
  ...
  get hasAlways() {return this._always === ""; }
  toAlways = () => this._always = "";
  resetAlways = () => this._always = LabelMode[this._labelMode].always;
  get always() {return this._always; }
  get hasAuto() {return this._auto === ""; }
  toAuto = () => this._auto = "";
  resetAuto = () => this._auto = LabelMode[this._labelMode].auto;
  get auto() {return this._auto; }
  get hasHidden() {return this._hidden === ""; }
  toHidden = () => this._hidden = "";
  resetHidden = () => this._hidden = LabelMode[this._labelMode].hidden;
  get hidden() {return this._hidden; }
  static get hidden() {return new LabelMode('hidden', null, null, ""); }
  get isHidden() {return this._labelMode === 'hidden'; }
  static get always() {return new LabelMode('always', "", null, null); }
  get isAlways() {return this._labelMode === 'always'; }
  static get auto() {return new LabelMode('auto', null, "", null); }
  get isAuto() {return this._labelMode === 'auto'; }
