export const AppMessages_vi = {
  NEED_LOGIN_TO_ACCESS: "Bạn cần đăng nhập để truy cập được trang này!",
  REGISTER_ACCOUNT_SUCCESS: (username) => `Tài khoản ${username} đăng ký thành công!`,
  DEFAULT_ERROR_MESSAGE: "Có lỗi xảy ra, vui lòng thử lại!",
  PLEASE_INPUT: (fieldName) => `Vui lòng nhập ${fieldName}`,
