...
import {unmapped, XeLabel} from "../../i18n";
...
export class AdminComponent {
  ...
  menu = [
    ...
    {title: XeLabel.BUSS_SCHEDULES, icon: {icon: 'bus', pack: 'fa'}, link: Url.app.ADMIN.BUSS.noHost, hidden: Url.app.ADMIN.BUSS.forbidden()},
    {title: XeLabel.EMPLOYEE, icon: {icon: 'users-cog', pack: 'fa'}, link: Url.app.ADMIN.EMPLOYEE.noHost, hidden: Url.app.ADMIN.EMPLOYEE.forbidden()},
