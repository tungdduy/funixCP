...
export class AdminComponent {
  menu = [
    ...
    {title: 'Xe và lịch trình', icon: {icon: 'bus', pack: 'fa'}, link: Url.app.ADMIN.BUSS.noHost, hidden: Url.app.ADMIN.BUSS.forbidden()},
    {title: 'Nhân viên', icon: {icon: 'users-cog', pack: 'fa'}, link: Url.app.ADMIN.EMPLOYEE.noHost, hidden: Url.app.ADMIN.EMPLOYEE.forbidden()},
    {title: 'Điểm dừng', icon: {icon: 'flag', pack: 'fa'}, link: Url.app.ADMIN.BUSS_POINT.noHost, hidden: Url.app.ADMIN.BUSS_POINT.forbidden()},
