...
export class AdminComponent {
  ...
  menu = [
    ...
    {title: XeLabel.FIND_TRIPS, icon: {icon: 'luggage-cart', pack: 'fa'}, link: Url.app.ADMIN.FIND_TRIP.noHost, hidden: Url.app.ADMIN.FIND_TRIP.forbidden() || AuthUtil.instance.isStaff()},
    {title: XeLabel.MY_TRIPS, icon: {icon: 'suitcase-rolling', pack: 'fa'}, link: Url.app.ADMIN.MY_TRIP.noHost, hidden: Url.app.ADMIN.MY_TRIP.forbidden() || AuthUtil.instance.isStaff()},
    ...
    {title: XeLabel.PATH, icon: {icon: 'road', pack: 'fa'}, link: Url.app.ADMIN.PATH.noHost, hidden: Url.app.ADMIN.PATH.forbidden() || AuthUtil.instance.isNonEmployee()},
